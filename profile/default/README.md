# Default OSXfce Profile

This profile is the committed, shareable XFCE state that makes a clean XFCE
session adopt the OSXfce layout.

It includes selected sanitized dotfiles only:

- XFCE panel layout, plugin order, separators, and applet settings
